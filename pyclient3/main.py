...
class Application:
    ...
    def save_keys(self, private_key, public_key):
        ...
        with open('pyclient3/private_key.txt', 'w') as f:
            f.write(private_key)
        with open('pyclient3/public_key.txt', 'w') as f:
            f.write(public_key)
    ...
    def login_method(self):
        ...
        if username == "" or password == "":
            ...
            if df.empty:
                ...
                # ? Load keys from file
                with open('pyclient3/private_key.txt', 'r') as f:
                    private_key = f.read()
                with open('pyclient3/public_key.txt', 'r') as f:
                    public_key = f.read()
    ...
    def load_messages(self):
        ...
        with open('pyclient3/messages.txt', 'r') as f:
    ...
    def send_message(self):
        ...
        with open('pyclient3/messages.txt', 'a') as f:
